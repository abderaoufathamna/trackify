    ...
    <div class="flex flex-1">
        ...
        <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col shrink-0">
            ...
            <nav class="flex-1 px-3 py-6 space-y-6 overflow-y-auto">
                ...
                <div>
                    <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Users</p>
                    <a href="{{ route('admin.users.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.users.*') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="users" class="w-4 h-4"></i> All Users
                    </a>
                    <a href="{{ route('admin.users.create') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.users.create') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="user-plus" class="w-4 h-4"></i> Add User
                    </a>
                </div>

                <div>
                    <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Students</p>
                    <a href="{{ route('admin.students.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.students.*') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="graduation-cap" class="w-4 h-4"></i> All Students
                    </a>
                    <a href="{{ route('admin.modules.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.modules.index') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="book-open" class="w-4 h-4"></i> All Modules
                    </a>
                    <a href="{{ route('admin.modules.create') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.modules.create') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.subscriptions.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.subscriptions.*') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="credit-card" class="w-4 h-4"></i> All Subscriptions
                    </a>
                </div>

                <div>
                    <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Attendance</p>
                    <a href="{{ route('admin.attendance.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                              {{ request()->routeIs('admin.attendance.*') ? 'bg-brand-600 text-white' : 'hover:bg-slate-800 hover:text-white' }}">
                        <i data-lucide="calendar-check" class="w-4 h-4"></i> View Attendance
                    </a>
                </div>
